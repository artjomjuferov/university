...
uses
  ...
  Dialogs, Menus, Author, Task, StdCtrls, Buttons, Clipbrd, Work, Series,
...
begin
    ...
    lnsrsSeries2.Clear;
    if n<6 then begin
       for i:=1 to n do Series1.Add(mas[i],IntToStr(i));
    end
    else if n<11 then begin
            for i:=1 to n do Series2.Add(mas[i],IntToStr(i));
    end
    else for i:=1 to n do lnsrsSeries2.Add(mas[i],IntToStr(i));
end;
